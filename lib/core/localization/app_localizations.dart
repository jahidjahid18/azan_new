...
_localizedValues = <String, Map<String, String>>{
  'en': <String, String>{
    ...
    'makruhTimeTitle': 'Makruh Time',
    'makruhTimeSub': 'After Asr until Maghrib',
    'makruhUntilTime': 'Until {time}',
    'prayerTimes': 'Prayer Times',
    'copyTodaySchedule': 'Copy today schedule',
    'shareTodaySchedule': 'Share today schedule',
    ...
    'dailyQuranAyahsTitle': "Daily Ayah's",
    'dailyQuranAyahsSubtitle':
        '3 ayahs for today with transliteration and translation',
    'refreshDailyAyahs': 'Refresh daily ayahs',
    'dailyQuranAyahsRefreshed': 'Loaded a new ayah set for today',
    ...
    'showProhibitedTimes': 'Show prohibited times',
    'showProhibitedTimesSub': 'Display Makruh/forbidden prayer windows',
  ...
  'ar': <String, String>{
    ...
    'shareTodaySchedule': 'مشاركة جدول اليوم',
    'scheduleCopied': 'تم نسخ الجدول',
    'scheduleShared': 'تمت مشاركة الجدول',
  ...
  'ms': <String, String>{
    ...
    'shareTodaySchedule': 'Kongsi jadual hari ini',
    'scheduleCopied': 'Jadual disalin',
    'scheduleShared': 'Jadual dikongsi',
    'language': 'Bahasa',
  ...
  'id': <String, String>{
    ...
    'shareTodaySchedule': 'Bagikan jadwal hari ini',
    'scheduleCopied': 'Jadwal disalin',
    'scheduleShared': 'Jadwal dibagikan',
    'language': 'Bahasa',
    'languageSub': 'Pilih bahasa aplikasi dan terjemahan Quran',
    'appLanguage': 'Bahasa aplikasi',
    'quranSubtitle': '114 Surah - Arab + terjemahan',
  ...
  'ur': <String, String>{
    ...
    'shareTodaySchedule': 'آج کا شیڈول شیئر کریں',
    'scheduleCopied': 'شیڈول کاپی ہو گیا',
    'scheduleShared': 'شیڈول شیئر ہو گیا',
    'language': 'زبان',
  ...
  'hi': <String, String>{
    ...
    'shareTodaySchedule': 'आज का शेड्यूल शेयर करें',
    'scheduleCopied': 'शेड्यूल कॉपी हो गया',
    'scheduleShared': 'शेड्यूल शेयर हो गया',
    'language': 'भाषा',
  ...
  'tr': <String, String>{
    ...
    'shareTodaySchedule': 'Bugünkü programı paylaş',
    'scheduleCopied': 'Program kopyalandı',
    'scheduleShared': 'Program paylaşıldı',
    'language': 'Dil',
